...
const WatBijProblemenPage = () => {
  return (
    <div className="WatBijProblemenPage">
      ...
      <p>Stuur een mail naar Kim (<a href="mailto:kim@codefever.be">kim@codefever.be</a>) met Kristien (<a href="mailto:kristien@codefever.be">kristien@codefever.be</a>) in CC.</p>
    </div>
  );
};
